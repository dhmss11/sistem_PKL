  ...
  >
    ...
    <div className="mb-3">
      ...
      <Calendar
        ...
        name="TGL"
        value={
          form.TGL && /^\d{4}-\d{2}-\d{2}$/.test(form.TGL)
            ? new Date(`${form.TGL}T00:00:00`)
            : null
        }
        onChange={(e) => {
          const date = e.value;
          if (date instanceof Date && !isNaN(date)) {
            ...
            setForm((prev) => ({ ...prev, TGL: formatted }));
          } else {
            setForm((prev) => ({ ...prev, TGL: '' }));
          }
        }}
        dateFormat="yy-mm-dd"
        showIcon
    ...
    <div className="mb-3">
      ...
      <Dropdown
        ...
        name="GUDANG"
        value={form.GUDANG}
        options={gudangOptions} // hasil dari fetchGudang()
    ...
    {/* dan seterusnya untuk DEBET, KREDIT, HARGA, DISCITEM, DISCFAKTUR1, DISCFAKTUR2, HP, KETERANGAN, DATETIME, USERNAME, URUT, SATUAN, PPN */}
